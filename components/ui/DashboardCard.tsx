...
export const DashboardCard: React.FC<DashboardCardProps> = memo(({ 
  ...
  return (
    <article 
      className={`group/card relative bg-[#09090b]/60 backdrop-blur-md border border-white/10 rounded-xl overflow-hidden flex flex-col hover:border-cyan-500/30 transition-all duration-500 will-change-transform animate-float-subtle ${className}`}
      style={{ animationDelay: floatDelay }}
      data-aos="fade-up"
      data-aos-delay={delay}
      onMouseMove={handleMouseMove}
    >
      {/* 1. Desktop Spotlight - Hardware Accelerated via GPU */}
      <motion.div
      ...
      <div className="relative flex-1 p-0 overflow-hidden h-full z-10 [contain:layout_paint]">
