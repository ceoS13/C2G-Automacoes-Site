...
const roles = [
    { name: "Agente SDR", status: "Ativo", color: "bg-orange-400", shadowColor: "shadow-[0_0_6px_rgba(251,146,60,0.6)]" },
    { name: "Agente Closer", status: "Ativo", color: "bg-emerald-400", shadowColor: "shadow-[0_0_6px_rgba(52,211,153,0.6)]" },
    { name: "Bot Suporte", status: "Ocioso", color: "bg-blue-400", shadowColor: "shadow-[0_0_6px_rgba(96,165,250,0.6)]" }
];
                ...
                {roles.map((role, i) => (
                    <div key={i} className="flex items-center justify-between p-2 md:p-2.5 rounded-lg bg-white/5 border border-white/5 hover:bg-white/10 transition-colors">
                        <div className="flex items-center gap-2 md:gap-3">
                            <div className={`w-2 h-2 rounded-full ${role.color} ${role.shadowColor} animate-pulse`} />
