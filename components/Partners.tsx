...
const PARTNERS = [
  ...
  },
  {
    ...
    viewBox: "0 0 24 24",
    path: (
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.93 13.91c-1.74 0-2.34-1.29-3.23-3.21-.92 1.96-1.57 3.21-3.27 3.21-1.44 0-2.43-1.07-2.43-2.62 0-1.89 1.43-3.04 2.65-3.04 1.48 0 2.22 1.05 3.05 2.87.89-1.92 1.62-2.87 3.14-2.87 1.54 0 2.5 1.14 2.5 2.76 0 1.66-1.04 2.9-2.41 2.9z" />
    )
  },
  {
    name: 'Google Gemini',
