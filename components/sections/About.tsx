...
const ManifestoCard: React.FC<{
    ...
    return (
        <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5, delay: node.delay / 1000 }}
        >
            <div
        ...
        <section id="about" className="py-24 md:py-40 bg-[#050505] relative border-t border-white/5 overflow-visible">
            ...
            <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6 relative mb-32">
                ...
                <motion.div
                    ...
                    className="hidden md:block absolute top-1/2 left-6 right-6 h-[1px] bg-white/10 -translate-y-1/2 z-0 overflow-hidden rounded-full origin-left"
                >
                    <motion.div
                        style={{ left: beamLeft }}
            ...
            <motion.div
                id="team"
                className="text-center pt-8 mb-16 border-t border-white/5"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
