...
const PricingCard: React.FC<PricingPlan> = React.memo(({ title, subtitle, price, description, features, benefit, highlight, delay, floatDelay }) => {
  ...
  return (
    <motion.article
      className={`relative rounded-3xl h-full transition-all duration-300 group/card will-change-transform`}
      ...
      `}>
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl transition-all font-medium relative overflow-hidden group ${highlight
    ...
    <section id="pricing" className="py-20 md:py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-[100rem] mx-auto px-6 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 max-w-full mx-auto">
          ...
          <motion.article
            className="relative rounded-3xl h-full card-premium transition-all duration-300 hover:border-white/30 group/card overflow-hidden"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
