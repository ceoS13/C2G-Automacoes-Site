    ...
    <section id="tech" className="py-12 md:py-32 bg-[#050505] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 relative z-10">
        ...
        >
          ...
          {/* Stats Cards overlay */}
          <motion.div
            className="absolute -bottom-4 right-2 md:-bottom-6 md:right-8 bg-[#111] border border-white/10 p-3 md:p-4 rounded-xl shadow-2xl transform rotate-3 z-30 scale-90 md:scale-100"
          ...
          <motion.div
            className="absolute -top-4 left-2 md:-top-6 md:left-8 bg-[#111] border border-white/10 p-3 md:p-4 rounded-xl shadow-2xl transform -rotate-2 z-30 scale-90 md:scale-100"
            initial={{ opacity: 0, scale: 0.8 }}
            whileInView={{ opacity: 1, scale: 0.9 }}
            viewport={{ once: true }}
